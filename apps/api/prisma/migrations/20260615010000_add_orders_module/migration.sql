-- CreateEnum
CREATE TYPE "OrderStatus" AS ENUM ('DRAFT', 'CONFIRMED', 'IN_KITCHEN', 'PREPARING', 'READY', 'SERVED', 'PAID', 'CANCELLED');
...
-- CreateIndex
CREATE INDEX "Order_restaurantId_branchId_idx" ON "Order"("restaurantId", "branchId");
